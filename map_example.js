$(document).ready(function () {
    var DateTime = luxon.DateTime;
        ...
        var new_heatmap;
        var update_cache;
        var map_611ae1ea252342b3a610c004d09e0358 = L.map(
        ...
        ).setView([34.04336110903858, -118.25038889069691], 18);


        var tile_layer_12702c5d484544a1afd7a770e13e3699 = L.tileLayer(
        ...
        var latlngs = [];
        var heat_map_9742ec1740444fea95c7fa38271f2180 = L.heatLayer(
            latlngs,
            {"blur": 18, "max": 1.0, "maxOpacity": 0.8, "maxZoom": 18, "minOpacity": 0.2, "radius": 10}
        ).addTo(map_611ae1ea252342b3a610c004d09e0358);

        var current_cache = map_611ae1ea252342b3a610c004d09e0358.getBounds();
        var max_north = current_cache._northEast.lat;
        var max_south = current_cache._southWest.lat;
        var max_east = current_cache._northEast.lng;
        var max_west = current_cache._southWest.lng;
...
// map_611ae1ea252342b3a610c004d09e0358.maxBounds([[34.034367839694845, -118.23953329151861], [34.05239832548047, -118.23958491234966]]);
    ...
    function mapdelay() {
        ...
        function maprefresh( event ) {
            var current_bounds = map_611ae1ea252342b3a610c004d09e0358.getBounds();
